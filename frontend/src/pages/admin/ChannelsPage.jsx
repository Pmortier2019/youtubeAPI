  ...
  return (
    <div style={{ padding: '40px 40px 60px' }}>
      <div style={{ marginBottom: 32 }}>
        <h1 style={{ fontSize: 28, fontWeight: 800, color: '#0f172a', marginBottom: 6 }}>Channels</h1>
        <p style={{ fontSize: 14, color: '#64748b' }}>All linked YouTube channels. Trigger a manual scrape per channel.</p>
      </div>
      ...
      {channels.length === 0 ? (
        <div style={{
          ...
          <p style={{ fontSize: 16, color: '#64748b' }}>No channels linked yet.</p>
        </div>
      ) : (
            ...
            <div key={ch.id} style={{
              ...
              <div style={{ flex: 1, minWidth: 200 }}>
                <div style={{ fontWeight: 700, fontSize: 15, color: '#0f172a' }}>
                  ...
                  {ch.channelHandle && (
                    <span style={{ marginLeft: 8, fontSize: 13, color: '#0ea5e9', fontWeight: 600 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                {results[ch.id] && (
                  <span style={{
                    ...
                    color: results[ch.id].ok ? '#15803d' : '#dc2626',
                  }}>
                    {results[ch.id].ok
                ...
                <button
                  ...
                  style={{
                    padding: '8px 18px',
                    background: scraping[ch.id] ? '#f1f5f9' : 'linear-gradient(135deg, #0ea5e9, #0891b2)',
                    ...
                    fontWeight: 600,
                    whiteSpace: 'nowrap',
                    boxShadow: scraping[ch.id] ? 'none' : '0 2px 8px rgba(14,165,233,0.3)',
                  }}
                >
